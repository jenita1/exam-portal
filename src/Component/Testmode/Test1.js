...
var post_api = "https://ujai96180i.execute-api.us-east-1.amazonaws.com/solution-arch-tstmd/exam-web";
    ...
    render() {
        ...
        const renderanswer= currentanswer.map((todo, index) => {
            ...
            return <div>
                ...
                <p className={(correct)?'greenColor':(user_ans_correct)?'redColor':''}  key={index}>
                    <input
                        name="ans"
                        value={index+1}
                        type="checkbox"
